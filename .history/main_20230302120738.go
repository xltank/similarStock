...
func getStockData() {
	params := `{"api_name": "daily", "token": "bf0569836c92efcb6c52aa66063bbb923dbf958e54eb1431894db06e", "params": {"ts_code":"000001.SZ", "start_date":"20180701", "end_date":"20180718"}, "fields": "ts_code,trade_date,open,high,low,close,pre_close,change,pct_chg,vol,amount"}`
	res := model.Res{}
	_, e := c.R().SetHeader("Content-Type", "application/json").SetBody(params).SetResult(&res).Post(Api)
	if e != nil {
		fmt.Println("error:", e.Error())
