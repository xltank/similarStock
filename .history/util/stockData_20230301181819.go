...
func test() {
	...
	params := `{"api_name": "stock_basic", "token": "$Token", "params": {"exchange":"", "start_date":"$start_date", "end_date":"$end_date", "is_open":"0"}, "fields": "exchange,cal_date,is_open,pretrade_date"}`
