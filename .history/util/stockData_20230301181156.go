...
func test() {
	...
	params := `{"api_name": "trade_cal", "token": "xxxxxxxx", "params": {"exchange":"", "start_date":"xxxxxxxx", "end_date":"yyyyyyyy", "is_open":"0"}, "fields": "exchange,cal_date,is_open,pretrade_date"}`

	http.Post("", "application/json", io.read([]byte(params)))
